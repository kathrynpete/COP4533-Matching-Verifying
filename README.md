...
1. Instructions to run the matcher:
    ...
    - Ensure current directory is COP4533-Matching-Verifying and run this command: `python src/matching_algo.py`
...
2. Instructions to run the verifier:
    ...
    - Alternatively, ensure current directory is COP4533-Matching-Verifying and run this command: `python src/verifier.py`
